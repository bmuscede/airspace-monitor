//-----------------------------------------------------------------------
// Raspberry Pi EInk Box
//
//
// Uses YAPP (Yet Another Parametric Projectbox)
...
// Padding Options
// No padding is required as we are using the "Main" PCB
// as the size of our box.
paddingFront        = 0;
paddingBack         = 0;
paddingRight        = 0;
paddingLeft         = 0;
...
pcbLength           = 185; // front to back (X axis)
pcbWidth            = 125; // side to side (Y axis)
pcbThickness        = 1.6; 
...
pcb = 
[
  // Default Main PCB (Defines the Dimensions of the Box)
  ["Main", pcbLength, pcbWidth, 0, 0, pcbThickness, standoffHeight,standoffDiameter, standoffPinDiameter, standoffHoleSlack],
  ["RaspberryPi", 85, 56, , , pcbThickness, standoffHeight, standoffDiameter, standoffPinDiameter, standoffHoleSlack]
];
...
// Locations for displays go here.
// This contains the main display for the Waveshare
displayMounts =
[
  // [posx, posy, displayWidth, displayHeight, pinInsetH, pinInsetV, pinDiameter, postOverhang, walltoPCBGap, pcbThickness, windowWidth, windowHeight, windowOffsetH, windowOffsetV, bevel, yappCoordBoxInside]
  [7.4, 6.9, 170.2, 111.2, 2.5, 2.5, 1.5, -0.5, 1.8, 1.6, 160, 96, 0, 0, 1.5, yappCoordBoxInside]
];
...
pcbStands = 
[
    [15, 15, 3, undef, 6, 2.4, 0.4, 0, 0, yappBaseOnly, yappCoordBoxInside], // Bottom-Left Hole
    [15 + 58, 15, 3, undef, 6, 2.4, 0.4, 0, 0, yappBaseOnly, yappCoordBoxInside], // Bottom-Right Hole
    [15, 15 + 49, 3, undef, 6, 2.4, 0.4, 0, 0, yappBaseOnly, yappCoordBoxInside], // Top-Left Hole
    [15 + 58, 15 + 49, 3, undef, 6, 2.4, 0.4, 0, 0, yappBaseOnly, yappCoordBoxInside]
];
...
cutoutsBase = 
[
  // [from_Back_X, from_Left_Y, width_X, length_Y, corner_radius, shape, depth, angle, yappCoordBoxInside]
  
  // Panel Mount USB-C Port (Placed 20mm from the back wall and 20mm from the left wall)
